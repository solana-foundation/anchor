...
- lang: Add `Migration<'info, From, To>` account type for schema migrations
  ...
  ([#4060](https://github.com/otter-sec/anchor/pull/4060)).
...
- avm: Added flags and version labels to explicitly handle pre-releases
  ...
  ([#4335](https://github.com/otter-sec/anchor/pull/4335))
- avm: Added `avm self-update` command and passive version check warning for
  out of date avm
  ([#4338](https://github.com/otter-sec/anchor/pull/4338))
...
- client: Fix deadlock when having multiple websocket listeners 
  ([#4250](https://github.com/otter-sec/anchor/pull/4250)).
- lang: Fix incorrect deserialization for dynamically sized types when using
  `lazy-account`
  ([#4319](https://github.com/otter-sec/anchor/pull/4319))
- avm: Using a temporary installation dir on cargo install calls to prevent
  ...
  ([#4343](https://github.com/otter-sec/anchor/pull/4343))

### Breaking

- cli: Remove program `arch` options
  ([#4295](https://github.com/otter-sec/anchor/pull/4295)).
- lang: Disallow duplicate mutable accounts by default. But allows duplicate
  ...
  ([#3946](https://github.com/otter-sec/anchor/pull/3946)).
- cli: Remove program id arguments of `idl init` and `idl upgrade` commands
  ([#4130](https://github.com/otter-sec/anchor/pull/4130)).
- lang: Rename `utils` module of `declare_program!` to `parsers`
  ([#4151](https://github.com/otter-sec/anchor/pull/4151)).
- lang: Remove the `interface-instructions` feature and the `#[interface]`
  attribute
  ([#4156](https://github.com/otter-sec/anchor/pull/4156)).
- cli: Remove the `login` command
  ([#4182](https://github.com/otter-sec/anchor/pull/4182)).
- idl: Exclude external accounts
  ([#4197](https://github.com/otter-sec/anchor/pull/4197)).
- idl: Remove the conflicting account names check
  ([#4294](https://github.com/otter-sec/anchor/pull/4294)).
- deps: Update to Solana 3.0
  ([#4031](https://github.com/otter-sec/anchor/pull/4031)).
- idl: Remove legacy IDL instructions and integrate Program Metadata for IDL
  management
  ([#3798](https://github.com/otter-sec/anchor/pull/3798)).
- ts: Rename TypeScript packages from `@coral-xyz/anchor` to
  `@anchor-lang/core`
  ([#4141](https://github.com/otter-sec/anchor/pull/4141)).
- lang: Remove program account info from CPI context
  ([#2762](https://github.com/otter-sec/anchor/pull/2762)).
...
([#3757](https://github.com/otter-sec/anchor/pull/3757)).
...
((#3863)[https://github.com/otter-sec/anchor/pull/3863]).
- lang: remove Solang
([#3824](https://github.com/otter-sec/anchor/pull/3824)).
- cli: remove `anchor publish` command
([#3795](https://github.com/otter-sec/anchor/pull/3795)).
...
- cli, docker: Replace `backpackapp/build` Docker image with
  ...
  ([#3619](https://github.com/otter-sec/anchor/pull/3619)).
- ts: Make `Provider` require publicKey instead of wallet in accounts resolver
  ([#3613](https://github.com/otter-sec/anchor/pull/3613))

### Fixes

- idl: Update `proc-macro2` usage for latest nightly
  ([#3663](https://github.com/otter-sec/anchor/pull/3663))
- ts: Fix parsing IDL with multiple const generics
  ([#3665](https://github.com/otter-sec/anchor/pull/3665))
...
- lang: Fix using non-instruction composite accounts with `declare_program!`
  ([#3290](https://github.com/otter-sec/anchor/pull/3290)).
- idl: Fix instructions with tuple parameters not producing an
  error([#3294](https://github.com/otter-sec/anchor/pull/3294)).
- ts: Update `engines.node` to `>= 17`
  ([#3301](https://github.com/otter-sec/anchor/pull/3301)).
- cli: Use OS-agnostic paths
  ([#3307](https://github.com/otter-sec/anchor/pull/3307)).
- avm: Use `rustc 1.79.0` when installing versions older than v0.31
  ([#3315](https://github.com/otter-sec/anchor/pull/3315)).
- cli: Fix priority fee calculation causing panic on localnet
  ([#3318](https://github.com/otter-sec/anchor/pull/3318)).
- cli: Fix `shell` command failing due to outdated program initialization
  ([#3351](https://github.com/otter-sec/anchor/pull/3351)).
...
- cli: Remove passing the rent sysvar account to IDL instructions
  ([#3372](https://github.com/otter-sec/anchor/pull/3372)).
- lang: Fix `cpi` feature instructions not accounting for discriminator
  overrides ([#3376](https://github.com/otter-sec/anchor/pull/3376)).
- idl: Ignore compiler warnings during builds
  ([#3396](https://github.com/otter-sec/anchor/pull/3396)).
- cli: Avoid extra IDL generation during `verify`
  ([#3398](https://github.com/otter-sec/anchor/pull/3398)).
- lang: Require `zero` accounts to be unique
  ([#3409](https://github.com/otter-sec/anchor/pull/3409)).
- lang: Deduplicate `zero` accounts against `init` accounts
  ([#3422](https://github.com/otter-sec/anchor/pull/3422)).
- cli: Fix custom `provider.cluster`
  ([#3428](https://github.com/otter-sec/anchor/pull/3428)).
- cli: Ignore non semver solana/agave releases to avoid panic
  ([#3432](https://github.com/otter-sec/anchor/pull/3432)).
...
- lang: Remove a potential panic while getting the IDL in `declare_program!`
  ([#3458](https://github.com/otter-sec/anchor/pull/3458)).
- cli: Fix altering user-provided lib names
  ([#3467](https://github.com/otter-sec/anchor/pull/3467)).
...
- lang: Fix adding `derive`s and `repr`s to type alias definitions in
  `declare_program!` ([#3504](https://github.com/otter-sec/anchor/pull/3504)).
...
- client: Remove `std::process::exit` usage
  ([#3544](https://github.com/otter-sec/anchor/pull/3544)).
...
- lang: Fix instructions with no accounts causing compilation errors when using
  `declare_program!` ([#3567](https://github.com/otter-sec/anchor/pull/3567)).
...
- cli: Use camelCase for program name in `anchor.workspace` templates
  ([#3581](https://github.com/otter-sec/anchor/pull/3581)).

### Breaking

- syn: Remove `bpf` target support in `hash` feature
  ([#3078](https://github.com/otter-sec/anchor/pull/3078)).
- client: Add `tokio` support to `RequestBuilder` with `async` feature
  ([#3057](https://github.com/otter-sec/anchor/pull/3057)).
- lang: Remove `EventData` trait
  ([#3083](https://github.com/otter-sec/anchor/pull/3083)).
- client: Remove `async_rpc` method
  ([#3053](https://github.com/otter-sec/anchor/pull/3053)).
- lang: Make discriminator type unsized
  ([#3098](https://github.com/otter-sec/anchor/pull/3098)).
- lang: Require `Discriminator` trait impl when using the `zero` constraint
  ([#3118](https://github.com/otter-sec/anchor/pull/3118)).
- ts: Remove `DISCRIMINATOR_SIZE` constant
  ([#3120](https://github.com/otter-sec/anchor/pull/3120)).
- lang: `#[account]` attribute arguments no longer parses identifiers as
  namespaces ([#3140](https://github.com/otter-sec/anchor/pull/3140)).
- spl: Rename metadata interface instruction fields from `token_program_id` to
  `program_id` ([#3076](https://github.com/otter-sec/anchor/pull/3076)).
- lang, ts: Remove "8 byte" requirement from discriminator error messages
  ([#3161](https://github.com/otter-sec/anchor/pull/3161)).
- lang: Remove `discriminator` method from `Discriminator` trait
  ([#3163](https://github.com/otter-sec/anchor/pull/3163)).
- docker: Upgrade `node` to 20.16.0 LTS
  ([#3179](https://github.com/otter-sec/anchor/pull/3179)).
- ts: Change the `Program` constructor's `idl` parameter type to `any`
  ([#3181](https://github.com/otter-sec/anchor/pull/3181)).
- lang, spl: Remove `borsh 0.9` support
  ([#3199](https://github.com/otter-sec/anchor/pull/3199)).
- ts: Upgrade `typescript` to `5.5.4` and remove the generic parameters of
  `SimulateResponse` ([#3221](https://github.com/otter-sec/anchor/pull/3221)).
- ts: Remove
  `StateCoder`([#3224](https://github.com/otter-sec/anchor/pull/3224)).
- cli: Accept integers for `warp_slot`
  ([#3235](https://github.com/otter-sec/anchor/pull/3235)).
- lang: Remove `EventIndex`
  ([#3244](https://github.com/otter-sec/anchor/pull/3244)).
- spl: Remove `dex` feature
  ([#3257](https://github.com/otter-sec/anchor/pull/3257)).
- client, lang, spl: Upgrade Solana to v2 and SPL to the latest
  ([#3219](https://github.com/otter-sec/anchor/pull/3219)).
- cli: Install Solana from anza.xyz domain in Docker verifiable builds
  ([#3271](https://github.com/otter-sec/anchor/pull/3271)).
- spl: Upgrade SPL deps to latest
  ([#3346](https://github.com/otter-sec/anchor/pull/3346)).
- cli: Upgrade `typescript` version of templates to v5
  ([#3480](https://github.com/otter-sec/anchor/pull/3480)).
- ts: Remove `snake-case` dependency
  ([#3507](https://github.com/otter-sec/anchor/pull/3507)).
...
- ts: Remove `programId` parameter of the `Program` constructor
  ([#2864](https://github.com/otter-sec/anchor/pull/2864)).
- idl, syn: Move IDL types from the `anchor-syn` crate to the new IDL crate
  ([#2882](https://github.com/otter-sec/anchor/pull/2882)).
- idl: Add `#[non_exhaustive]` to IDL enums
  ([#2890](https://github.com/otter-sec/anchor/pull/2890)).
...
- lang: Change all accounts to have a reference to `AccountInfo`
  ([#2656](https://github.com/otter-sec/anchor/pull/2656)).
- lang: Add `get_lamports`, `add_lamports` and `sub_lamports` methods for all
  account types ([#2552](https://github.com/otter-sec/anchor/pull/2552)).
- client: Add a helper struct `DynSigner` to simplify use of
  ...
  ([#2550](https://github.com/otter-sec/anchor/pull/2550)).
- lang: Allow CPI calls matching an interface without pinning program ID
  ([#2559](https://github.com/otter-sec/anchor/pull/2559)).
- cli, lang: Add IDL generation through compilation. `anchor build` still uses
  ...
  the build method ([#2011](https://github.com/otter-sec/anchor/pull/2011)).
- avm: Add support for the `.anchorversion` file to facilitate switching between
  different versions of the `anchor-cli`
  ([#2553](https://github.com/otter-sec/anchor/pull/2553)).
- ts: Add ability to access workspace programs independent of the casing used,
  ...
  ([#2579](https://github.com/otter-sec/anchor/pull/2579)).
- bench: Add benchmarking for program binary size
  ([#2591](https://github.com/otter-sec/anchor/pull/2591)).
- spl: Export `mpl-token-metadata` crate
  ([#2583](https://github.com/otter-sec/anchor/pull/2583)).
- spl: Add `TokenRecordAccount` for pNFTs
  ([#2597](https://github.com/otter-sec/anchor/pull/2597)).
- ts: Add support for unnamed(tuple) enum in accounts
  ([#2601](https://github.com/otter-sec/anchor/pull/2601)).
- cli: Add program template with multiple files for instructions, state...
  ([#2602](https://github.com/otter-sec/anchor/pull/2602)).
- bench: Add benchmarking for stack memory usage
  ([#2617](https://github.com/otter-sec/anchor/pull/2617)).
- lang: `Box` the inner enums of `anchor_lang::error::Error` to optimize
  `anchor_lang::Result`
  ([#2600](https://github.com/otter-sec/anchor/pull/2600)).
- ts: Add strong type support for `Program.addEventListener` method
  ([#2627](https://github.com/otter-sec/anchor/pull/2627)).
- syn: Add `IdlBuild` trait to implement IDL support for custom types
  ([#2629](https://github.com/otter-sec/anchor/pull/2629)).
...
- cli: `anchor_version` and `solana_version` property in `Anchor.toml` that was
  ...
  ([#2649](https://github.com/otter-sec/anchor/pull/2649)).
...
- client: Add `async` feature flag to use an asynchronous anchor-client
  ([#2488](https://github.com/otter-sec/anchor/pull/2488)).
- spl: Add metadata wrappers `approve_collection_authority`,
  ...
  ([#2430](https://github.com/otter-sec/anchor/pull/2430))
- spl: Add `token_program` constraint to `Token`, `Mint`, and `AssociatedToken`
  ...
  ([#2460](https://github.com/otter-sec/anchor/pull/2460))
- cli: Add support for Solidity programs. `anchor init` and `anchor new` take an
  ...
  ([#2421](https://github.com/otter-sec/anchor/pull/2421))
- bench: Add benchmarking for compute units usage
  ([#2466](https://github.com/otter-sec/anchor/pull/2466))
...
- lang: `account(zero_copy)` and `zero_copy` attributes now derive the
  ...
  ([#2330](https://github.com/otter-sec/anchor/pull/2330)). This imposes useful
...
- ts: Remove `createProgramAddressSync`, `findProgramAddressSync` (now available
  ...
  ([#2357](https://github.com/otter-sec/anchor/pull/2357)).
...
- spl: Add `freeze_delegated_account` and `thaw_delegated_account` wrappers
  ([#2164](https://github.com/otter-sec/anchor/pull/2164)).
- ts: Add `feePayer` check to `AnchorProvider` methods, so that anchor writes
  ...
  ([#2186](https://github.com/otter-sec/anchor/pull/2186)).
- ts: Add nested PDA inference
  ([#2194](https://github.com/otter-sec/anchor/pull/2194)).
...
- lang: Add `Discriminator` and `Owner` trait implementation for structures
  ...
  ([#1997](https://github.com/otter-sec/anchor/pull/1997)).
- ts: '@coral-xyz/borsh' package is now part of the yarn monorepo
  ([#2290](https://github.com/otter-sec/anchor/pull/2290)). The borsh package
  ...
  [#2299](https://github.com/otter-sec/anchor/pull/2299) and
  [#2306](https://github.com/otter-sec/anchor/pull/2306).
- lang: Add support for optionally passing in accounts using the syntax
  ...
  [#2101](https://github.com/otter-sec/anchor/pull/2101).
- ts: Switch from `@project-serum/anchor` to the `@coral-xyz/anchor` package
  [#2318](https://github.com/otter-sec/anchor/pull/2318).
...
- lang: Fix `returns` being serialized as `null` instead of `undefined` in IDL
  ([#1782](https://github.com/otter-sec/anchor/pull/1782)).
...
- lang: Fix `anchor build` failing if `Test.toml` included a relative path that
  ...
  ([#1772](https://github.com/otter-sec/anchor/pull/1772)).
- cli: Update js/ts template to use new `AnchorProvider` class
  ([#1770](https://github.com/otter-sec/anchor/pull/1770)).
...
- cli: make `anchor test` fail when used with `--skip-deploy` option and without
  ...
  ([#1675](https://github.com/otter-sec/anchor/pull/1675)).
- lang: Return proper error instead of panicking if account length is smaller
  ...
  ([#1678](https://github.com/otter-sec/anchor/pull/1678)).
- cli: Add `@types/bn.js` to `devDependencies` in cli template
  ([#1712](https://github.com/otter-sec/anchor/pull/1712)).
- ts: Event listener no longer crashes on Program Upgrade or any other
  unexpected log ([#1757](https://github.com/otter-sec/anchor/pull/1757)).

### Breaking

- avm: `avm install` switches to the newly installed version after installation
  finishes ([#1670](https://github.com/otter-sec/anchor/pull/1670)).
- spl: Re-export the `spl_token` crate
  ([#1665](https://github.com/otter-sec/anchor/pull/1665)).
- lang, cli, spl: Update solana toolchain to v1.9.13
  ([#1653](https://github.com/otter-sec/anchor/pull/1653) and
  [#1751](https://github.com/otter-sec/anchor/pull/1751)).
- lang: `Program` type now deserializes `programdata_address` only on demand
  ([#1723](https://github.com/otter-sec/anchor/pull/1723)).
- ts: Make `Provider` an interface and adjust its signatures and add
  `AnchorProvider` implementor class
  ([#1707](https://github.com/otter-sec/anchor/pull/1707)).
- spl: Change "to" to "from" in `token::burn`
  ([#1080](https://github.com/otter-sec/anchor/pull/1080)).
...
- cli: Fix rust template
  ([#1488](https://github.com/otter-sec/anchor/pull/1488)).
- lang: Handle array sizes with variable sizes in events and array size casting
  in IDL parsing ([#1485](https://github.com/otter-sec/anchor/pull/1485))
...
- lang: Add check that declared id == program id
  ([#1451](https://github.com/otter-sec/anchor/pull/1451)).
- ts: Added float types support
  ([#1425](https://github.com/otter-sec/anchor/pull/1425)).
- cli: Add `--skip-lint` option to disable check linting introduced in
  ([#1452](https://github.com/otter-sec/anchor/pull/1452)) for rapid prototyping
  ([#1482](https://github.com/otter-sec/anchor/pull/1482)).

### Fixes

- ts: Allow nullable types for `Option<T>` mapped types
  ([#1428](https://github.com/otter-sec/anchor/pull/1428)).

### Breaking

- lang: Enforce that the payer for an init-ed account be marked `mut`
  ([#1271](https://github.com/otter-sec/anchor/pull/1271)).
- lang: All error-related code is now in the error module
  ([#1426](https://github.com/otter-sec/anchor/pull/1426)).
- lang: Require doc comments when using AccountInfo or UncheckedAccount types
  ([#1452](https://github.com/otter-sec/anchor/pull/1452)).
- lang: add
  ...
  ([#1462](https://github.com/otter-sec/anchor/pull/1462)). This change will
...
- lang: Providing `bump = <target>` targets with `init` will now error. On
  ...
  compute units used ([#1380](https://github.com/otter-sec/anchor/pull/1380)).
- ts: `Coder` is now an interface and the existing class has been renamed to
  ...
  anchor programs
  ([#1259](https://github.com/otter-sec/anchor/pull/1259/files)).
...
- lang: Improved error msgs when required programs are missing when using the
  `init` constraint([#1257](https://github.com/otter-sec/anchor/pull/1257))

### Features

- lang: Allow repr overrides for zero copy accounts
  ([#1273](https://github.com/otter-sec/anchor/pull/1273)).
...
- ts: fix `translateAddress` which currently leads to failing browser code. Now
  ...
  minifying/mangling([#1138](https://github.com/otter-sec/anchor/pull/1138))
- lang: add missing check that verifies that account is ATA when using
  `init_if_needed` and init is not
  needed([#1221](https://github.com/otter-sec/anchor/pull/1221))
...
- lang: Add `programdata_address: Option<Pubkey>` field to `Program` account.
  ...
  ([#1125](https://github.com/otter-sec/anchor/pull/1125))
- lang,ts,ci,cli,docs: update solana toolchain to version
  1.8.5([#1133](https://github.com/otter-sec/anchor/pull/1133)).
- lang: Account wrappers for non-Anchor programs no longer have to implement the
  ...
  default([#1156](https://github.com/otter-sec/anchor/pull/1156)).
- lang: Add `set_inner` method to `Account<'a, T>` to enable easy updates
  ([#1177](https://github.com/otter-sec/anchor/pull/1177)).
- lang: Handle arrays with const as length
  ([#968](https://github.com/otter-sec/anchor/pull/968)).
- ts: Add optional commitment argument to `fetch` and `fetchMultiple`
  ([#1171](https://github.com/otter-sec/anchor/pull/1171)).
- lang: Implement `AsRef<T>` for
  `Account<'a, T>`([#1173](https://github.com/otter-sec/anchor/pull/1173))
- cli: Add `anchor expand` command which wraps around `cargo expand`
  ([#1160](https://github.com/otter-sec/anchor/pull/1160))

### Breaking

- client: Client::new and Client::new_with_options now accept `Rc<dyn Signer>`
  instead of `Keypair` ([#975](https://github.com/otter-sec/anchor/pull/975)).
- lang, ts: Change error enum name and message for 'wrong program ownership'
  account validation ([#1154](https://github.com/otter-sec/anchor/pull/1154)).
- lang: Change from `#[repr(packed)]` to `#[repr(C)]` for zero copy accounts
  ([#1106](https://github.com/otter-sec/anchor/pull/1106)).
- lang: Account types can now be found either in the `prelude` module or the
  ...
  ([#1208](https://github.com/otter-sec/anchor/pull/1208)).
...
- lang: Add `deprecated` attribute to `ProgramAccount`
  ([#1014](https://github.com/otter-sec/anchor/pull/1014)).
- cli: Add version number from programs `Cargo.toml` into extracted IDL
  ([#1061](https://github.com/otter-sec/anchor/pull/1061)).
- lang: Add `deprecated` attribute to
  `Loader`([#1078](https://github.com/otter-sec/anchor/pull/1078)).
- lang: the `init_if_needed` attribute now checks that given attributes (e.g.
  ...
  needed ([#1096](https://github.com/otter-sec/anchor/pull/1096)).
...
- lang: `ProgramData` and `UpgradableLoaderState` can now be passed into
  ...
  ([#1095](https://github.com/otter-sec/anchor/pull/1095)).
...
- lang: Add `SystemAccount<'info>` account type for generic wallet addresses or
  ...
  ([#954](https://github.com/otter-sec/anchor/pull/954))

### Fixes

- cli: fix dns in NODE_OPTIONS
  ([#928](https://github.com/otter-sec/anchor/pull/928)).
- cli: output TypeScript IDL in `idl parse` subcommand
  ([#941](https://github.com/otter-sec/anchor/pull/941)).
- cli: Add fields `os` and `cpu` to npm package `@project-serum/anchor-cli`
  ([#976](https://github.com/otter-sec/anchor/pull/976)).
- cli: Allow specify output directory for TypeScript IDL
  ([#940](https://github.com/otter-sec/anchor/pull/940)).

### Breaking

- spl: Move permissioned markets into dex repository
  ([#962](https://github.com/otter-sec/anchor/pull/962)).
...
- cli: Add `localnet` command for starting a local `solana-test-validator` with
  the workspace deployed ([#820](https://github.com/otter-sec/anchor/pull/820)).
...
- `CpiContext` accounts must now be used with the accounts struct generated in
  ...
  ([#824](https://github.com/otter-sec/anchor/pull/824)).
...
- lang: `Signer` type now sets isSigner to true in the IDL
  ([#750](https://github.com/otter-sec/anchor/pull/750)).
...
- lang: `Program` type introduced for executable accounts
  ([#705](https://github.com/otter-sec/anchor/pull/705)).
...
- lang: `UncheckedAccount` type introduced as a preferred alias for
  `AccountInfo` ([#745](https://github.com/otter-sec/anchor/pull/745)).

### Breaking Changes

- lang: `#[account(owner = <pubkey>)]` now requires a `Pubkey` instead of an
  account ([#691](https://github.com/otter-sec/anchor/pull/691)).
...
- lang: Add new `Account` type to replace `ProgramAccount` and `CpiAccount`,
  ...
  ([#686](https://github.com/otter-sec/anchor/pull/686)).
...
- lang: Add `Owner` trait, which is automatically implemented by all
  `#[account]` structs ([#686](https://github.com/otter-sec/anchor/pull/686)).
- lang: Check that ProgramAccount writable before mut borrow (`anchor-debug`
  only) ([#681](https://github.com/otter-sec/anchor/pull/681)).

### Breaking Changes

- lang: All programs must now define their program id in source via
  `declare_id!` ([#686](https://github.com/otter-sec/anchor/pull/686)).
...
- lang: `#[associated]` and `#[account(associated = <target>, with = <target>)]`
  are both removed ([#612](https://github.com/otter-sec/anchor/pull/612)).
- cli: Removed `anchor launch` command
  ([#634](https://github.com/otter-sec/anchor/pull/634)).
- lang: `#[account(init)]` now creates the account inside the same instruction
  ...
  ([#641](https://github.com/otter-sec/anchor/pull/641)).
...
- lang: `try_from` methods for `ProgramAccount`, `Loader`, and `ProgramState`
  ...
  ([#660](https://github.com/otter-sec/anchor/pull/660)).
...
- cli: Fix `anchor init` command "Workspace not found" regression
  ([#598](https://github.com/otter-sec/anchor/pull/598)).
...
- cli: Programs embedded into genesis during tests will produce program logs
  ([#594](https://github.com/otter-sec/anchor/pull/594)).

### Fixes

- cli: Allows Cargo.lock to exist in workspace subdirectories when publishing
  ([#593](https://github.com/otter-sec/anchor/pull/593)).
...
- cli: Adds a `[registry]` section in the Anchor toml
  ([#570](https://github.com/otter-sec/anchor/pull/570)).
...
- lang: Dynamically fetch rent sysvar for when using `init`
  ([#587](https://github.com/otter-sec/anchor/pull/587)).

### Breaking

- cli: `[clusters.<network>]` Anchor.toml section has been renamed to
  `[programs.<network>]` ([#570](https://github.com/otter-sec/anchor/pull/570)).
- cli: `[workspace]` member and exclude arrays must now be filepaths relative to
  the workspace root ([#570](https://github.com/otter-sec/anchor/pull/570)).
...
- cli: Add keys `members` / `exclude` in config `programs` section
  ([#546](https://github.com/otter-sec/anchor/pull/546)).
- cli: Allow program address configuration for test command through
  `clusters.localnet` ([#554](https://github.com/otter-sec/anchor/pull/554)).
- lang: IDLs are now parsed from the entire crate
  ([#517](https://github.com/otter-sec/anchor/pull/517)).
- spl: Dex permissioned markets proxy
  ([#519](https://github.com/otter-sec/anchor/pull/519),
  [#543](https://github.com/otter-sec/anchor/pull/543)).

### Breaking Changes

- ts: Use `hex` by default for decoding Instruction
  ([#547](https://github.com/otter-sec/anchor/pull/547)).
- lang: `CpiAccount::reload` mutates the existing struct instead of returning a
  new one ([#526](https://github.com/otter-sec/anchor/pull/526)).
- cli: Anchor.toml now requires an explicit `[scripts]` test command
  ([#550](https://github.com/otter-sec/anchor/pull/550)).
...
- lang: Adds `require` macro for specifying assertions that return error codes
  on failure ([#483](https://github.com/otter-sec/anchor/pull/483)).
- lang: Allow one to specify arbitrary programs as the owner when creating PDA
  ([#483](https://github.com/otter-sec/anchor/pull/483)).
...
- ts: Event listener not firing when creating associated accounts
  ([#356](https://github.com/otter-sec/anchor/issues/356)).
...
- lang: Add fallback functions
  ([#457](https://github.com/otter-sec/anchor/pull/457)).
- lang: Add feature flag for using the old state account discriminator. This is
  ...
  ([#446](https://github.com/otter-sec/anchor/pull/446)).
- lang: Add generic support to Accounts
  ([#496](https://github.com/otter-sec/anchor/pull/496)).

### Breaking Changes

- cli: Remove `.spec` suffix on TypeScript tests files
  ([#441](https://github.com/otter-sec/anchor/pull/441)).
- lang: Remove `belongs_to` constraint
  ([#459](https://github.com/otter-sec/anchor/pull/459)).
...
- lang: Add `#[account(address = <expr>)]` constraint for asserting the address
  of an account ([#400](https://github.com/otter-sec/anchor/pull/400)).
- lang: Add
  ...
  ([#400](https://github.com/otter-sec/anchor/pull/400)).
...
- cli: `[clusters.<network>]` table entries can now also use
  ...
  programs ([#400](https://github.com/otter-sec/anchor/pull/400)).

### Breaking Changes

- cli: Remove `--yarn` flag in favor of using `npx`
  ([#432](https://github.com/otter-sec/anchor/pull/432)).
...
- lang: Instruction data is now available to accounts constraints
  ([#386](https://github.com/otter-sec/anchor/pull/386)).
...
- lang: Event field names in IDLs are now mixed case.
  ([#379](https://github.com/otter-sec/anchor/pull/379)).
...
- cli: Add `--program-name` option for build command to build a single program
  at a time ([#362](https://github.com/otter-sec/anchor/pull/362)).
- cli, client: Parse custom cluster urls from str
  ([#369](https://github.com/otter-sec/anchor/pull/369)).
- cli, client, lang: Update solana toolchain to v1.7.1
  ([#368](https://github.com/otter-sec/anchor/pull/369)).
- ts: Instruction decoding and formatting
  ([#372](https://github.com/otter-sec/anchor/pull/372)).
...
- lang, ts: Framework defined error codes are introduced, reserving error codes
  ...
  ([#354](https://github.com/otter-sec/anchor/pull/354)).
...
- ts: Retrieving deserialized accounts from the `<program>.account.<my-account>`
  ...
  `program.state.fetch()`
  ([#322](https://github.com/otter-sec/anchor/pull/322)).
...
- lang, ts: Change domain delimiters for the pre-image of the instruction
  ...
  ([#321](https://github.com/otter-sec/anchor/pull/321)).
...
- lang: Associated `space` constraints must now be literal integers instead of
  literal strings ([#341](https://github.com/otter-sec/anchor/pull/341)).
...
- client: Adds support for state instructions
  ([#248](https://github.com/otter-sec/anchor/pull/248)).
- lang: Add `anchor-debug` feature flag for logging
  ([#253](https://github.com/otter-sec/anchor/pull/253)).
- ts: Add support for u16
  ([#255](https://github.com/otter-sec/anchor/pull/255)).
...
- spl: Add serum DEX CPI client
  ([#224](https://github.com/otter-sec/anchor/pull/224)).
...
- lang: Allows one to specify multiple `with` targets when creating associated
  accounts ([#197](https://github.com/otter-sec/anchor/pull/197)).
- lang, ts: Add array support
  ([#202](https://github.com/otter-sec/anchor/pull/202)).
- lang: Zero copy deserialization for accounts
  ([#202](https://github.com/otter-sec/anchor/pull/202),
  [#206](https://github.com/otter-sec/anchor/pull/206)).
- lang, spl, cli, client: Upgrade solana toolchain to 1.6.6
  ([#210](https://github.com/otter-sec/anchor/pull/210)).
...
- lang: CPI clients for program state instructions
  ([#43](https://github.com/otter-sec/anchor/pull/43)).
- lang: Add `#[account(owner = <program>)]` constraint
  ([#178](https://github.com/otter-sec/anchor/pull/178)).
- lang, cli, ts: Add `#[account(associated = <target>)]` and `#[associated]`
  ...
  ([#186](https://github.com/otter-sec/anchor/pull/186)).

### Fixes

- lang: Unused `#[account]`s are now parsed into the IDL correctly
  ([#177](https://github.com/otter-sec/anchor/pull/177)).
...
- cli: Fund Anchor.toml configured wallet when testing
  ([#164](https://github.com/otter-sec/anchor/pull/164)).
- spl: Add initialize_account instruction for spl tokens
  ([#166](https://github.com/otter-sec/anchor/pull/166)).

## [0.4.1] - 2021-04-06

- cli: Version verifiable docker builder
  ([#145](https://github.com/otter-sec/anchor/pull/145)).
...
- cli: Specify test files to run
  ([#118](https://github.com/otter-sec/anchor/pull/118)).
- lang: Allow overriding the `#[state]` account's size
  ([#121](https://github.com/otter-sec/anchor/pull/121)).
- lang, client, ts: Add event emission and subscriptions
  ([#89](https://github.com/otter-sec/anchor/pull/89)).
- lang/account: Allow namespacing account discriminators
  ([#128](https://github.com/otter-sec/anchor/pull/128)).
- cli: TypeScript migrations
  ([#132](https://github.com/otter-sec/anchor/pull/132)).
- lang: Add `#[account(executable)]` attribute
  ([#140](https://github.com/otter-sec/anchor/pull/140)).
...
- lang: Changes the account discriminator of `IdlAccount` to be namespaced by
  `"internal"` ([#128](https://github.com/otter-sec/anchor/pull/128)).
- lang, spl, cli: Upgrade solana toolchain to 1.6.3, a major version upgrade
  ...
  ([#139](https://github.com/otter-sec/anchor/pull/139)).
...
- ts: Allow preloading instructions for state rpc transactions
  ([cf9c84](https://github.com/otter-sec/anchor/commit/cf9c847e4144989b5bc1936149d171e90204777b)).
- ts: Export sighash coder function
  ([734c75](https://github.com/otter-sec/anchor/commit/734c751882f43beec7ea3f0f4d988b502e3f24e4)).
- cli: Specify programs to embed into local validator genesis via Anchor.toml
  while testing
  ([b3803a](https://github.com/otter-sec/anchor/commit/b3803aec03fbbae1a794c9aa6a789e6cb58fda99)).
- cli: Allow skipping the creation of a local validator when testing against
  localnet ([#93](https://github.com/otter-sec/anchor/pull/93)).
- cli: Adds support for tests with Typescript
  ([#94](https://github.com/otter-sec/anchor/pull/94)).
- cli: Deterministic and verifiable builds
  ([#100](https://github.com/otter-sec/anchor/pull/100)).
- cli, lang: Add write buffers for IDL upgrades
  ([#107](https://github.com/otter-sec/anchor/pull/107)).
...
- cli: Propagates mocha test exit status on error
  ([79b791](https://github.com/otter-sec/anchor/commit/79b791ffa85ffae5b6163fa853562aa568650f21)).
...
- cli: Embed workspace programs into local validator genesis when testing
  ([733ec3](https://github.com/otter-sec/anchor/commit/733ec300b0308e7d007873b0975585d836333fd4)).
- cli: Stream program logs to `.anchor/program-logs` directory when testing
  ([ce5ca7](https://github.com/otter-sec/anchor/commit/ce5ca7ddab6e0fd579deddcd02094b3f798bbe6a)).
- spl: Add shared memory api
  [(d92cb1)](https://github.com/otter-sec/anchor/commit/d92cb1516b78696d1257e41d0c5ac6821716300e).
- lang/attribute/access-control: Allow specifying multiple modifier functions
  ([845df6](https://github.com/otter-sec/anchor/commit/845df6d1960bb544fa0f2e3331ec79cc804edeb6)).
- lang/syn: Allow state structs that don't have a ctor or impl block (just trait
  implementations)
  ([a78000](https://github.com/otter-sec/anchor/commit/a7800026833d64579e5b19c90d724ecc20d2a455)).
- ts: Add instruction method to state namespace
  ([627c27](https://github.com/otter-sec/anchor/commit/627c275e9cdf3dafafcf44473ba8146cc7979d44)).
- lang/syn, ts: Add support for u128 and i128
  ([#83](https://github.com/otter-sec/anchor/pull/83)).
...
- lang: Adds the ability to create and use CPI program interfaces
  ([#66](https://github.com/otter-sec/anchor/pull/66/files?file-filters%5B%5D=)).

### Breaking Changes

- lang, client, ts: Migrate from rust enum based method dispatch to a variant of
  sighash ([#64](https://github.com/otter-sec/anchor/pull/64)).
