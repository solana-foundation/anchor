...
pub mod token_example {
    ...
    pub fn transfer_tokens(ctx: Context<TransferTokens>, amount: u64) -> Result<()> {
        ...
        let cpi_accounts = TransferChecked {
            ...
            from: ctx.accounts.sender_token_account.to_account_view(),
            to: ctx.accounts.recipient_token_account.to_account_view(),
            authority: ctx.accounts.signer.to_account_view(),
        };
        let cpi_program = ctx.accounts.token_program.to_account_view();
...
pub mod token_example {
    ...
    pub fn create_and_mint_tokens(ctx: Context<CreateAndMintTokens>, amount: u64) -> Result<()> {
        ...
        let cpi_accounts = MintTo {
            mint: ctx.accounts.mint.to_account_view(),
            to: ctx.accounts.token_account.to_account_view(),
            authority: ctx.accounts.mint.to_account_view(),
        };
        let cpi_program = ctx.accounts.token_program.to_account_view();
    ...
    pub fn transfer_tokens(ctx: Context<TransferTokens>) -> Result<()> {
        ...
        let cpi_accounts = TransferChecked {
            ...
            from: ctx.accounts.sender_token_account.to_account_view(),
            to: ctx.accounts.recipient_token_account.to_account_view(),
            authority: ctx.accounts.sender_token_account.to_account_view(),
        };
        let cpi_program = ctx.accounts.token_program.to_account_view();
        let cpi_context = CpiContext::new(cpi_program, cpi_accounts).with_signer(signer_seeds);
        token_interface::transfer_checked(cpi_context, amount, decimals)?;
