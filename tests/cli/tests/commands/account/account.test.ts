...
describe("account", () => {
  it("should succeed", () => {
    ...
    const idlPath = path.join(testDir, "../../../../templates/idl/squads.json");
    ...
    runCommands({
      ...
      commands: [
        ...
        // Run account command
        anchorCommand(`account --idl ${idlPath} squads_multisig_program.Multisig 9SLy7m2RZH6oAiqy1jHoQbTpnexqQM7VZnnTjVugsL5C --provider.wallet ${walletPath}`),
