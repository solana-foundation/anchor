...
describe("idl upgrade", () => {
  it.skip("should succeed", () => {
    ...
    const idlPath = path.join(testDir, "../../../../../templates/idl/test-program.json");
    ...
    runCommands({
      ...
      commands: [
        ...
        // Run idl upgrade command
        anchorCommand(`idl upgrade aaLWzFHRPNhQwft1971qmPg2Q5eHwsHEWivqSkCDo9x -f ${idlPath} --provider.wallet ${walletPath}`),
