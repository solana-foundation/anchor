...
mod wrapped {
    ...
    pub struct Feature(anchor_lang::pinocchio_runtime::feature::Feature);
    ...
    impl AnchorDeserialize for Feature {
        fn deserialize_reader<R: std::io::prelude::Read>(reader: &mut R) -> std::io::Result<Self> {
            Ok(Self(anchor_lang::pinocchio_runtime::feature::Feature {
    ...
    impl Clone for Feature {
        fn clone(&self) -> Self {
            Self(anchor_lang::pinocchio_runtime::feature::Feature {
