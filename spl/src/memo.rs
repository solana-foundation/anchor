...
pub fn build_memo(ctx: CpiContext<'_, '_, BuildMemo>, memo: &[u8]) -> Result<()> {
    ...
    crate::cpi_util::invoke_signed_solana_instruction(ix, &ctx.remaining_accounts, ctx.signer_seeds)
        .map_err(Into::into)
}
