...
A Docker image for each version of Anchor is published on [Docker Hub](https://hub.docker.com/r/solanafoundation/anchor) under tags of the form `solanafoundation/anchor:[2m<version>[0m{:ansi}`. To pull the image for Anchor `v1.0.1`:

```ansi
$ [34mdocker[0m pull solanafoundation/anchor:v1.0.1
```
