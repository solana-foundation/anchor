...
<Callout variant="note">
  The `$ [34manchor[0m build{:ansi}` command writes the IDL to `/target/idl/<program-name>.json`.
</Callout>
...
See the `gen_discriminator{:rs}` [source](https://github.com/solana-foundation/anchor/blob/62865c636aecc6974fc9cfebfc6cf08ca4f0bb72/lang/syn/src/codegen/program/common.rs#L5-L22) for the implementation.
