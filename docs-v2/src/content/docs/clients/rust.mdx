...
The [`anchor-client`](https://docs.rs/anchor-client/latest/anchor_client/) crate is the Rust client library for interacting with Anchor programs. You can find the source code [here](https://github.com/solana-foundation/anchor/tree/62865c636aecc6974fc9cfebfc6cf08ca4f0bb72/client).
