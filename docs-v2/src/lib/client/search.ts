...
function searchScopePrefixes(): string[] {
  ...
  if (path.startsWith(updatesPrefix)) {
    ...
    const storedVersion = readStorage(localStorage, VERSION_STORAGE_KEY)
    const version =
