...
| boxedAccountEmpty1          | 844           | 🔴 **+13 (1.56%)** |
| boxedAccountEmptyInit2      | 8,496         | -                  |
| boxedAccountEmpty2          | 1,266         | 🔴 **+13 (1.04%)** |
...
| boxedAccountSized1          | 890           | 🔴 **+13 (1.48%)** |
...
| boxedAccountUnsized1        | 920           | 🔴 **+13 (1.43%)** |
...
| boxedInterfaceAccountMint1  | 1,103         | 🔴 **+13 (1.19%)** |
| boxedInterfaceAccountMint2  | 1,486         | -                  |
| boxedInterfaceAccountMint4  | 2,268         | -                  |
| boxedInterfaceAccountMint8  | 3,907         | -                  |
| boxedInterfaceAccountToken1 | 1,230         | 🔴 **+13 (1.07%)** |
| boxedInterfaceAccountToken2 | 1,728         | -                  |
| boxedInterfaceAccountToken4 | 2,740         | -                  |
| boxedInterfaceAccountToken8 | 4,839         | -                  |
| interfaceAccountMint1       | 1,118         | 🔴 **+13 (1.18%)** |
| interfaceAccountMint2       | 1,490         | -                  |
| interfaceAccountMint4       | 2,268         | -                  |
| interfaceAccountMint8       | 3,835         | -                  |
| interfaceAccountToken1      | 1,250         | 🔴 **+13 (1.05%)** |
| interfaceAccountToken2      | 1,749         | -                  |
| interfaceAccountToken4      | 2,775         | -                  |
| interface1                  | 896           | 🔴 **+13 (1.47%)** |
| interface2                  | 1,042         | 🔴 **+13 (1.26%)** |
| interface4                  | 1,308         | -                  |
| interface8                  | 1,873         | -                  |
| program1                    | 912           | 🔴 **+13 (1.45%)** |
| program2                    | 1,062         | 🔴 **+13 (1.24%)** |
| program4                    | 1,336         | -                  |
| program8                    | 1,917         | -                  |
| signer1                     | 901           | 🔴 **+13 (1.46%)** |
| signer2                     | 1,250         | 🔴 **+13 (1.05%)** |
| signer4                     | 1,920         | -                  |
| signer8                     | 3,293         | -                  |
| systemAccount1              | 923           | 🔴 **+13 (1.43%)** |
| systemAccount2              | 1,282         | 🔴 **+13 (1.02%)** |
| systemAccount4              | 1,972         | -                  |
| systemAccount8              | 3,385         | -                  |
| uncheckedAccount1           | 909           | 🔴 **+13 (1.45%)** |
| uncheckedAccount2           | 1,240         | 🔴 **+13 (1.06%)** |
