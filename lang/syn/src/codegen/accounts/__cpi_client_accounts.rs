    ...
    quote! {
        ...
        pub(crate) mod #account_mod_name {
            ...
            impl #generics anchor_lang::ToAccountMetas for #name #generics {
                fn to_account_metas(&self, is_signer: Option<bool>) -> anchor_lang::prelude::Vec<anchor_lang::solana_program::instruction::AccountMeta> {
                    let mut account_metas = anchor_lang::prelude::Vec::new();
            ...
            impl<'info> anchor_lang::ToAccountInfos<'info> for #name #generics {
                fn to_account_infos(&self) -> anchor_lang::prelude::Vec<anchor_lang::solana_program::account_info::AccountInfo<'info>> {
                    let mut account_infos = anchor_lang::prelude::Vec::new();
