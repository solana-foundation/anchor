...
fn generate_constraint_realloc(
    ...
    quote! {
        ...
        let __new_rent_minimum = anchor_lang::arch_program::account::MIN_ACCOUNT_LAMPORTS;
...
fn generate_constraint_init_group(
    ...
    match &c.kind {
        ...
        //     let payer_optional_check = check_scope.generate_check(payer);
            ...
            // // };
            // // let mint_space = quote! { anchor_lang::arch_program::account::MIN_ACCOUNT_LAMPORTS };
                ...
                let #field = ({ #[inline(never)] || {
                    ...
                    if #if_needed {
...

                        {
                            ...
                            let required_lamports = anchor_lang::arch_program::account::MIN_ACCOUNT_LAMPORTS;
...
fn generate_create_account(
    ...
    quote! {
        ...
        if __current_lamports == 0 {
            ...
            let required_lamports = anchor_lang::arch_program::account::MIN_ACCOUNT_LAMPORTS.saturating_sub(__current_lamports);
